const data = {
  ...
  resume: "../Santhoshi.pdf",
  about: "A Passionate Full Stack Developer with hands-on experience through internships and real-time projects. Skilled in creating dynamic, responsive web applications using React.js, Node.js, and Express.js. Eager to leverage my expertise in frontend, backend, and Java technologies to build innovative, scalable solutions and contribute to high-impact projects in collaborative environments.",
  // skills: {
  ...
  education: {
    ...
    school: "Mina Institute of Engineering and Technology for Women, JNTUH University",
